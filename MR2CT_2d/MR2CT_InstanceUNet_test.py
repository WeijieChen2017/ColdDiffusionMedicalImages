...
from demixing_diffusion_pytorch import instance_trainer_MR2CT as trainer
...
parser.add_argument('--load_path', default='./proj/MR2CT_InstanceleUNet/model_400000.pt', type=str)
